...
<head>
    ...
    <!-- Title Page-->
    <title>TRMS › Account › Technician</title>
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Technician</li>
                                    </ul>
                                </div>
			...
			<div class="container-fluid">
				<!-- DATA TABLE -->
					...
					if (mysqli_num_rows($query)==0)
					{
						...
						<div class="page-wrapper" style="margin: 0 auto;text-align: center;"><h1>No user in database</h1></div>
						<div class="page-wrapper"><h1>&nbsp;</h1></div>
						<div class="page-wrapper"><h1>&nbsp;</h1></div>
						<!--end replace-->
						<?php
					...
					else
					{
						...
						<div class="container-fluid">
							<div class="table-data__tool">
								<strong style="color: white;padding-left: 25px; padding-top: 5px;">ALL TECHNICIAN</strong>
								<a href="add_technician.php">
								...
								<table class="table table-data2">
									...
									<tbody>
										...
										while($rowTech = mysqli_fetch_array($query)) 
										{
											...
											$tech_staff = $rowTech['User_Staff_No'];
											$tech_name = $rowTech['User_Name'];
											$tech_email = $rowTech['User_Email'];
											$tech_gender = $rowTech['User_Gender'];
											$tech_role = $rowTech['User_Role'];
											$tech_status = $rowTech['User_Is_Active'];
										?>
											<tr class="tr-shadow">
												<td><?php echo $tech_staff; ?></td>
												<td><?php echo $tech_name; ?></td>
												<td><span class="badge-info" style="padding:5px;"><?php echo $tech_email; ?></span></td>
												<td><?php echo $tech_gender; ?></td>
												<td class="desc"><?php echo $tech_role; ?></td>
												<td>
													<label class="switch switch-3d switch-success mr-3">
														<input type="checkbox" class="switch-input" <?php if($tech_status=='Yes'){echo 'checked="true"';} ?> disabled>
												...
												<td>
													<div class="table-data-feature">
														<button class="item" data-toggle="tooltip" data-placement="top" title="<?php if($tech_role=='Admin'){echo 'Demote';}else{echo 'Promote';} ?>">
															<a href="controllers/swap_role_control.php?user_id=<?php echo $tech_id ?>"><i class="zmdi <?php if($tech_role=='Admin'){echo 'zmdi-caret-down-circle';}else{echo 'zmdi-caret-up-circle';} ?>"></i></a>
														</button>
														<button class="item" data-toggle="tooltip" data-placement="top" title="<?php if($tech_status=='Yes'){echo 'Disable';}else{echo 'Enable';} ?>">
															<a href="controllers/toggle_user_control.php?user_id=<?php echo $tech_id ?>"><i class="zmdi <?php if($tech_status=='Yes'){echo 'zmdi-lock';}else{echo 'zmdi-lock-open';} ?>"></i></a>
														</button>
													</div>
												</td>
											</tr>
