<?php
	...
	include('./controllers/customer_control.php');
					...
					<div class="card-body card-block">
						<form id="frmCustomer" action="" method="post" class="form-horizontal">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="customer_project" name="customer_project" placeholder="Project" class="form-control">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="customer_division" name="customer_division" placeholder="Division" class="form-control">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="customer_unit" name="customer_unit" placeholder="Unit" class="form-control">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="customer_phone" name="customer_phone" placeholder="Phone No." class="form-control">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="customer_email" name="customer_email" placeholder="Email" class="form-control">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<textarea name="customer_address" id="customer_address" rows="5" placeholder="Address" class="form-control"></textarea>
