<?php
	...
	include('./controllers/technician_control.php');
...
<head>
    ...
    <!-- Title Page-->
    <title>TRMS › Account › Add Technician</title>
...
<body class="animsition">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Add Technician</li>
                                    </ul>
                                </div>
			...
			<div class="container-fluid">
				...
				<div class="card">
					<div class="card-header">
						<strong>TECHNICIAN SHEET</strong> 
					</div>
					<div class="card-body card-block">
						<form id="frmTechnician" action="" method="post" class="form-horizontal">
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="staff-input" class=" form-control-label">Technician Staff No.</label>
								</div>
								<div class="col-12 col-md-9">
									<input type="text" id="tech_staff" name="tech_staff" placeholder="Staff No" class="form-control">
									<label id="tech_staff-error" class="error text-danger" for="tech_staff"></label>
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="name-input" class=" form-control-label">Technician Name</label>
								</div>
								<div class="col-12 col-md-9">
									<input type="text" id="tech_name" name="tech_name" placeholder="Name" class="form-control">
									<label id="tech_name-error" class="error text-danger" for="tech_name"></label>
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="email-input" class=" form-control-label">Technician Email</label>
								</div>
								<div class="col-12 col-md-9">
									<input type="text" id="tech_email" name="tech_email" placeholder="Email" class="form-control">
									<label id="tech_email-error" class="error text-danger" for="tech_email"></label>
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="gender-input" class=" form-control-label">Technician Gender</label>
								</div>
								<div class="col-12 col-md-9">
									<select name="tech_gender" id="tech_gender" class="form-control">
										<option value="">Please select</option>
										<option value="Male">Male</option>
										<option value="Female">Female</option>
									</select>
									<label id="tech_gender-error" class="error text-danger" for="tech_gender"></label>
								</div>
							</div>
							</div>
							<div class="card-footer">
								<button type="submit" class="btn btn-primary" name="btnTech" id="btnTech">
	...
	<script>
	$(function() {
	   $( "#frmTechnician" ).validate({
			rules:
			{
				tech_name: {required: true},
				tech_staff: {required: true},
				tech_email: {required: true},
				tech_gender: {required: true},
			},
			messages:
			{
				tech_name: "Please key in technician name",
				tech_staff: "Please key in technician staff number",
				tech_email: 
				{
					required: "Please key in technician email",
					email: "Email address is incomplete",
				},
				tech_gender: "Please select technician gender",
			}
		});
	});
	</script>
