<?php
	...
	include('./controllers/edit_noti_control.php');
	...
	if(isset($_GET['noti_id']))
	{
		...
		$sql = "SELECT * From tblNotification WHERE Noti_ID = '{$noti_id}' ";
		$query = mysqli_query($connection, $sql);
		while($rowEdit = mysqli_fetch_array($query)) 
		{
			$noti_title = $rowEdit['Noti_Title'];
			$noti_content = $rowEdit['Noti_Content'];
			$noti_class = $rowEdit['Noti_Class'];
			$noti_date = $rowEdit['Noti_Date_Added'];
			$noti_active = $rowEdit['Noti_Is_Active'];
		}
	}
...
<head>
    ...
    <!-- Title Page-->
    <title>TRMS › Notifications › Edit Notifications</title>
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Edit Notifications</li>
                                    </ul>
                                </div>
					...
					<form id="frmNoti" action="" method="post">
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<input type="date" id="noti_date" name="noti_date" value="<?php echo $noti_date;?>" class="form-control">
								<input type="hidden" value="<?php echo $noti_id;?>" name="noti_id"></input>
							</div>
						</div>
						<div class="row form-group">
							<div class="col col-md-3">
							...
							<div class="col-12 col-md-9">
								<input type="text" id="noti_title" name="noti_title" placeholder="Title" value="<?php echo $noti_title;?>"class="form-control">
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<textarea name="noti_content" id="noti_content" rows="5" placeholder="Content" class="form-control"> <?php echo $noti_content;?></textarea>
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<select name="noti_class" id="noti_class" class="form-control">
									...
									<option value="primary" <?php if($noti_class=='primary'){echo 'selected';} ?>>Blue</option>
									<option value="success" <?php if($noti_class=='success'){echo 'selected';} ?>>Green</option>
									<option value="warning" <?php if($noti_class=='warning'){echo 'selected';} ?>>Yellow</option>
									<option value="danger" <?php if($noti_class=='danger'){echo 'selected';} ?>>Red</option>
								</select>
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<select name="noti_active" id="noti_active" class="form-control">
									<option value="">Please select</option>
									<option value="Yes" <?php if($noti_active=='Yes'){echo 'selected';} ?>>Yes</option>
									<option value="No" <?php if($noti_active=='No'){echo 'selected';} ?>>No</option>
								</select>
								<label id="noti_active-error" class="error text-danger" for="noti_active"></label>
							</div>
						</div>
					</div>
